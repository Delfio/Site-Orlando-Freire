<div class="content-mid">
    ...
    <div class="col-md-5">
      ...
      <!---Calender -------->
    <link rel="stylesheet" href="{{ URL:: asset('css/clndr.css')}}" type="text/css" />
    ...
    <script src="{{( URL:: asset)}}" type="text/javascript"></script>
    <!---End Calender -------->
    </div>
...
<div id="owl-demo" class="owl-carousel text-center">
    <div class="item">
        <img class="lazyOwl img-responsive" data-src="{{URL::to('/')}}/images/na.jpg" alt="name">
    </div>
    <div class="item">
        <img class="lazyOwl img-responsive" data-src="{{URL::to('/')}}/images/na1.jpg" alt="name">
    </div>
    <div class="item">
        <img class="lazyOwl img-responsive" data-src="{{URL::to('/')}}/images/na2.jpg" alt="name">
    </div>
    <div class="item">
        <img class="lazyOwl img-responsive" data-src="{{URL::to('/')}}/images/na.jpg" alt="name">
    </div>
...
<div class="content-bottom">
        ...
        <div class="weather">
            <div class="weather-top">
                <div class="weather-top-left">
                    ...
                    <span><iframe frameborder="0" allowtransparency="yes" scrolling="no" width="150" height="260" src="http://www.tempoagora.com.br/ta-widgets?cidades=PortoVelho-RO&amp;tipo=vertical"></iframe></span>
                    <div class="clearfix"></div>
                    </div>
        <script>
                ...
                <div class="weather-top-right">
                    <p><i class="fa fa-map-marker"></i>Porto Velho</p>
                    <label>PVH/RO</label>
                </div>
                <div class="clearfix"> </div>
            </div>
    ...
    <div class="weather-bottom1">
        <div class="weather-head">
            <iframe scrolling="no" frameborder="0" marginwidth="0" marginheight="0" width="150" height="170" src="https://selos.climatempo.com.br/selos/MostraSelo.php?CODCIDADE=343&SKIN=azul"></iframe>
    </div>
    </div>
    <div class="weather-bottom1">
        <div class="weather-head">
